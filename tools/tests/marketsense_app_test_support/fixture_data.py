...
def mock_definitions() -> list[ItemDefinition]:
    ...
    return [
        ...
        make("MiscBundle", {
            "itemType": "base:normal", "displayCategory": "General",
            "doubleClickRecipe": "OpenMiscBundle",
            "description": "a generic utility bundle",
            "canSpawnAsLoot": True,
        }),
        make("MiscAmbiguousBundle", {
            "itemType": "base:normal", "displayCategory": "General",
            "doubleClickRecipe": "OpenAmbiguousBundle",
            "description": "an ambiguous utility bundle",
            "canSpawnAsLoot": True,
        }),
        make("MoveableShelf", {
            "itemType": "base:moveable", "displayCategory": "Furniture",
...
def mock_yield_recipes() -> dict[str, list[dict[str, Any]]]:
    return {
        ...
        "MarketSenseFixture.MiscBundle": [{
            "recipe": "OpenMiscBundle",
            "source": "offline_recipe_graph",
            "sourceFullType": "MarketSenseFixture.MiscBundle",
            "inputAmount": 1.0,
            "inputCount": 1,
            "outputs": [{
                "fullType": "MarketSenseFixture.MiscFishing",
                "quantity": 6,
                "chance": 1.0,
                "inputFlags": [],
                "outputFlags": [],
        ...
        "MarketSenseFixture.MiscAmbiguousBundle": [
            {
                "recipe": "OpenAmbiguousBundleOne",
                "source": "offline_recipe_graph",
                "sourceFullType": "MarketSenseFixture.MiscAmbiguousBundle",
                "inputAmount": 1.0,
                "inputCount": 1,
                "outputs": [{
                    "fullType": "MarketSenseFixture.MiscFishing",
                ...
                "resolution": "exact",
                "nameHeuristic": True,
                "candidateMethod": "recipe_name",
            },
            {
                "recipe": "OpenAmbiguousBundleTwo",
                "source": "offline_recipe_graph",
                "sourceFullType": "MarketSenseFixture.MiscAmbiguousBundle",
                "inputAmount": 1.0,
                "inputCount": 1,
