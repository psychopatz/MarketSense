...
local TOKEN_TO_ROOT = {
    ...
    ContainerBagUtility = "Container", ContainerMedicalKit = "Container",
    ContainerCooler = "Container", ContainerToolRoll = "Container",
    ContainerSeedBag = "Container", ContainerWallet = "Container",
    ContainerPersonal = "Container", ContainerParcel = "Container",
    ContainerGift = "Container", ContainerUtility = "Container",
    ...
    FoodNonPerishableBeverage = "Food", FoodNonPerishableIngredient = "Food",
    FoodNonPerishableSauce = "Food", FoodModSpecific = "Food",
    -- Food perishable
    ...
    ToolMeasurement = "Tool", ToolConstruction = "Tool", ToolUtility = "Tool",
    ToolFireStarting = "Tool", ToolFishing = "Tool",
    Smoking = "Tool",
    -- Material / Resource
    Resource = "Resource",
    ...
    LiteratureRpgManual = "Literature", LiteratureHollowBook = "Literature",
    LiteratureHollowBookHandgun = "Literature", LiteratureHollowBookKids = "Literature",
    LiteratureHollowBookPrison = "Literature", LiteratureHollowBookValuables = "Literature",
    LiteratureHollowBookWhiskey = "Literature",
    ...
    GardeningPestControl = "Building", GardeningHarvest = "Building",
    ...
    ElectronicsClock = "Electronics", ElectronicsAudio = "Electronics",
    ElectronicsControl = "Electronics", ElectronicsPower = "Electronics",
    ElectronicsPersonal = "Electronics", ElectronicsEntertainment = "Electronics",
    ...
    BuildingGardenPlanter = "Building",
    ...
    Junk = "Misc", Misc = "Misc", MiscUtility = "Misc", MiscFire = "Misc",
    MiscFishing = "Misc", MiscSecurity = "Misc", MiscNavigation = "Misc",
    MiscRecreation = "Misc", MiscHousehold = "Misc", MiscSafety = "Misc",
    MiscAnimal = "Misc", MiscEntertainment = "Misc", MiscTrapping = "Misc",
}
...
local TOKEN_PARENTS = {
    ...
    ContainerBagUtility = { "ContainerBag", "Container" },
    ContainerMedicalKit = { "Container" }, ContainerCooler = { "Container" },
    ContainerToolRoll = { "Container" }, ContainerSeedBag = { "Container" },
    ContainerWallet = { "Container" }, ContainerPersonal = { "Container" },
    ContainerParcel = { "Container" }, ContainerGift = { "Container" },
    ContainerUtility = { "Container" },
    ...
    FoodNonPerishableBeverage = { "FoodNonPerishable" },
    FoodNonPerishableIngredient = { "FoodNonPerishable" },
    FoodNonPerishableSauce = { "FoodNonPerishable" },
    FoodModSpecific = { "FoodNonPerishable" },
    -- Food perishable
    ...
    ToolMeasurement = { "Tool" }, ToolConstruction = { "ToolCraft" },
    ToolUtility = { "Tool" }, ToolFireStarting = { "Tool" },
    ToolFishing = { "Tool" },
    -- Material
    ...
    LiteratureHollowBook = { "Literature" },
    LiteratureHollowBookHandgun = { "LiteratureHollowBook", "Literature" },
    LiteratureHollowBookKids = { "LiteratureHollowBook", "Literature" },
    LiteratureHollowBookPrison = { "LiteratureHollowBook", "Literature" },
    LiteratureHollowBookValuables = { "LiteratureHollowBook", "Literature" },
    LiteratureHollowBookWhiskey = { "LiteratureHollowBook", "Literature" },
    -- Gardening
    ...
    GardeningPestControl = { "Gardening" }, GardeningHarvest = { "Gardening" },
    -- Electronics
    ElectronicsBattery = { "Electronics" }, ElectronicsGenerator = { "Electronics" },
    ElectronicsRadio = { "Electronics" }, ElectronicsTelevision = { "Electronics" },
    ElectronicsCommunicator = { "Electronics" }, ElectronicsTransmitter = { "Electronics" },
    ...
    ElectronicsAudio = { "Electronics" }, ElectronicsControl = { "Electronics" },
    ElectronicsPower = { "Electronics" }, ElectronicsPersonal = { "Electronics" },
    ElectronicsEntertainment = { "Electronics" },
    -- Building
    ...
    BuildingGarden = { "Building" }, BuildingGardenPlanter = { "BuildingGarden" },
    BuildingMoveable = { "Building" },
    ...
    BuildingWallDecor = { "Building" },
    -- Miscellaneous utility families
    MiscUtility = { "Misc" }, MiscFire = { "Misc" }, MiscFishing = { "Misc" },
    MiscSecurity = { "Misc" }, MiscNavigation = { "Misc" },
    MiscRecreation = { "Misc" }, MiscHousehold = { "Misc" }, MiscSafety = { "Misc" },
    MiscAnimal = { "Misc" }, MiscEntertainment = { "Misc" }, MiscTrapping = { "Misc" },
    -- Memento
