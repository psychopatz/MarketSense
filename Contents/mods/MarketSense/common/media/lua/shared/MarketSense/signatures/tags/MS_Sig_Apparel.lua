...
local BLTOK_TO_CAT = {
    ...
    underwearBottom="ClothingUnderwear", underwearextra1="ClothingUnderwear",
    ...
    shoulderparleft="AccessoryArms", shoulderpadright="AccessoryArms",
    ...
    torsoextravstbullet="AccessoryTop", fannypackback="AccessoryTop",
